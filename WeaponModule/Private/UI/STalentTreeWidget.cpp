...
void STalentTreeWidget::Construct(const FArguments& InArgs)
{
	...
	RegisterActiveTimer(0.f, FWidgetActiveTimerDelegate::CreateSP(this, &STalentTreeWidget::HandleActiveTimer));
...
FSlateRect STalentTreeWidget::ResetButtonRect(const FVector2D& LocalSize) const
{
...
EActiveTimerReturnType STalentTreeWidget::HandleActiveTimer(double InCurrentTime, float InDeltaTime)
{
...
void STalentTreeWidget::PaintNodeTooltip(const FGeometry& AllottedGeometry, FSlateWindowElementList& OutDrawElements, int32 LayerId) const
{
...
FReply STalentTreeWidget::OnMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
